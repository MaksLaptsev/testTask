...
public class CreateRecipePdf {
    ...
    public void createCashRecipe(Cart cart) throws FileNotFoundException {
        ...
        totalAmountTable.addCell(new Cell().add(new Paragraph(String.valueOf(cart.getAmountWithoutDiscount ())))
                .setTextAlignment(TextAlignment.RIGHT)
                .setFontSize(8f)
                .setBorder(Border.NO_BORDER));
        ...
        if (cart.getCard()!= null){
            totalAmountTable.addCell(new Cell().add(new Paragraph("% DISC = "+cart.getCard().getPercentDiscount()))
                    .setTextAlignment(TextAlignment.LEFT)
                    .setFontSize(8f)
                    .setBorder(Border.NO_BORDER));
        ...
        totalAmountTable.addCell(new Cell().add(new Paragraph("$"+cart.getAmountWithDiscount()))
                .setTextAlignment(TextAlignment.RIGHT)
                .setBold()
                .setFontSize(15f)
                .setBorder(Border.NO_BORDER)
